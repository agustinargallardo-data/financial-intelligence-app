...
Sample data is stored in the `data/` folder for demonstration purposes.
...
- Visualizations to highlight financial behavior patterns
...
- Simple AI-driven financial recommendations
